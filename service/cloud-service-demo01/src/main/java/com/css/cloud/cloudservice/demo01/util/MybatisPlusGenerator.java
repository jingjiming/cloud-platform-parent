package com.css.cloud.cloudservice.demo01.util;
    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create(dataSourceConfig())
                ...
                .globalConfig(builder -> builder
                        ...
                        .disableOpenDir()
                        // 设置输出目录
                        .outputDir(System.getProperty("user.dir") + "/service/cloud-service-demo01/src/main/java")
                        // 设置作者
                        .author("jiming.jing")
                        // 开启Swagger模式
                        .enableSwagger()
                ...
                .packageConfig(builder -> builder
                        .parent("com.css.cloud.cloudservice.demo01")
                        //.pathInfo(pathMap)
                        .pathInfo(Collections.singletonMap(OutputFile.xml, System.getProperty("user.dir") + "/service/cloud-service-demo01/src/main/resources/mybatis/mapper")) // 设置mapperXml生成路径
                )
                // 策略配置
